 ...
 * filesystem paths.
 */
export const SWAP_FILE_SUFFIX = '.crswap';
export function swapPathFor(filePath) {
    return filePath + SWAP_FILE_SUFFIX;
}
export function isSwapFileName(name) {
    return name.endsWith(SWAP_FILE_SUFFIX);
}
//# sourceMappingURL=swapFile.js.map